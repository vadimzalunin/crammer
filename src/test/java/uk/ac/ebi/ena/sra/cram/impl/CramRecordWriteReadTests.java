...
public class CramRecordWriteReadTests {
	...
	// List<SubstitutionVariation> subs = new
	// ArrayList<SubstitutionVariation>();
	// subs.add(sub);
	...
	//
	// @Override
	// public void copyBases(String sequenceName, long from, int len,
	// byte[] dest) throws IOException {
