...
import uk.ac.ebi.ena.sra.cram.format.text.CramRecordTextFormatTest;
import uk.ac.ebi.ena.sra.cram.format.text.DefaultReadFeatureFormatTest;
...
@Suite.SuiteClasses({ BaseChangeCodecTest.class, BaseSequenceCodecTest.class,
		...
		SingleLineMaskReaderTest.class, CramRecordTextFormatTest.class,
