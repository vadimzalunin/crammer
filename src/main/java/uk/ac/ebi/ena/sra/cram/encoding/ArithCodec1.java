 ...
 */
public class ArithCodec1 implements ByteArrayBitCodec {
	 ...
	 */
	private Byte read(BitInputStream bis) throws IOException {
		this.baos.reset();
		this.fileData.clear();
		curBit = 0;
		curByte = 0;
	...
	public long write(BitOutputStream bos, byte[] object) throws IOException {
		stats.arraysWritten++;
		stats.bytesWritten += object.length;
